...
<p><h3>The tools that I use today</h3><img src="https://skillicons.dev/icons?i=typescript,python,dart,flutter,vue,laravel,express,adonis,mysql,mongodb,postgres,docker,supabase,nuxt,pinia">
